Shader "Darkcom/Triplanar Projection/World/DiffuseDetail" {
	Properties {
	...
	SubShader {
		...
		void surf(Input IN, inout SurfaceOutput o) {
			...
			fixed4 det = GetTriplanarProjection(_DetailTex, IN.worldPos, _DetailTex_ST, IN.weight);

#if IF_SNOW
			half3 worldNormal = WorldNormalVector(IN, o.Normal);
			o.Albedo = SnowProjection(worldNormal, _SnowDirection, _Snow, _Wetness, IN.worldPos, _SnowLevel, col.rgb * det.rgb *unity_ColorSpaceDouble.r);
#else
